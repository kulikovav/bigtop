...
#ZOOKEEPER_GIT_REPO=https://github.com/apache/zookeeper.git
#ZOOKEEPER_GIT_REF=release-$(ZOOKEEPER_PKG_VERSION)
#ZOOKEEPER_GIT_DIR=zookeeper-$(ZOOKEEPER_PKG_VERSION)
...
HADOOP_BASE_VERSION=2.7.2
HADOOP_PKG_VERSION=2.7.2
HADOOP_RELEASE_VERSION=1
#HADOOP_GIT_REPO=https://github.com/apache/hadoop.git
#HADOOP_GIT_REF=release-$(HADOOP_PKG_VERSION)
#HADOOP_GIT_DIR=$(HADOOP_NAME)-$(HADOOP_PKG_VERSION)-src
...
HBASE_DOWNLOAD_PATH=/hbase/$(HBASE_BASE_VERSION)
...
SPARK_PKG_VERSION=1.6.0.hadoop272
...
KNOX_PKG_NAME=knox
KNOX_BASE_VERSION=0.7.0
KNOX_JAR_VERSION=0
KNOX_PKG_VERSION=$(KNOX_BASE_VERSION)
KNOX_RELEASE_VERSION=1
KNOX_TARBALL_SRC=$(KNOX_NAME)-$(KNOX_BASE_VERSION)-src.zip
KNOX_TARBALL_DST=$(KNOX_NAME)-$(KNOX_BASE_VERSION).zip
KNOX_DOWNLOAD_PATH=/knox/$(KNOX_PKG_VERSION)
KNOX_SITE=$(APACHE_MIRROR)$(KNOX_DOWNLOAD_PATH)
KNOX_ARCHIVE=$(APACHE_MIRROR)$(KNOX_DOWNLOAD_PATH)
